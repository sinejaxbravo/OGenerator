...
#  IF ACCENTS PRESENT OR GET EVERYTHING IN-BETWEEN SLEEVES AND UNDERNEATH COLLAR. SO MAKE IT INTO A RECTANGLE
#  SO IF SHIRT PICTURE IS A 20X20 THEN GET A 8x5 OF THE SHIRT.
results = []
